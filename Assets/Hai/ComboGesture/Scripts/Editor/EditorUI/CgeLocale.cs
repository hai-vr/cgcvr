...
namespace Hai.ComboGesture.Scripts.Editor.EditorUI
{
    public class CgeLocale
    {
        ...
        internal static string CGEC_Animator_Controller => LocalizeOrElse("CGEC_Animator_Controller", CgeLocaleDefaults.CGEC_Animator_Controller);
        internal static string CGEC_Playable_Layer => LocalizeOrElse("CGEC_Playable_Layer", CgeLocaleDefaults.CGEC_Playable_Layer);
        ...
        internal static string CGEC_Synchronize_Animator_layers => LocalizeOrElse("CGEC_Synchronize_Animator_layers", CgeLocaleDefaults.CGEC_Synchronize_Animator_layers);
        ...
        internal static string CGEC_Write_Defaults => LocalizeOrElse("CGEC_Write_Defaults", CgeLocaleDefaults.CGEC_Write_Defaults);
